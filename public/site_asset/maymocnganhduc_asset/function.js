      ...
      (t = SEMICOLON.Mobile),
      {
        ...
        PageMenu: {
          init: function (e) {
            ...
            return (
              ...
              (a = t.querySelector(".page-menu-wrap-clone")) || (((a = document.createElement("div")).classList = "page-menu-wrap-clone"), e.parentNode.insertBefore(a, e.nextSibling), (a = t.querySelector(".page-menu-wrap-clone"))),
              ...
              ((i = N.getVars.elHeader.classList.contains("no-sticky")
                ? 0
          ...
          init: function (e) {
            return (
              ...
              (!N.getVars.elHeader.classList.contains("ignore-slider") &&
                ...
                ((e = N.getVars.elSlider.querySelector(".swiper-slide-active")), te(e)),
              !N.getVars.elHeader.classList.contains("ignore-slider") &&
                (N.getVars.elBody.classList.contains("is-expanded-menu") || (N.getVars.elHeader.classList.contains("transparent-header-responsive") && !N.getVars.elBody.classList.contains("primary-menu-open"))) &&
                ((e = N.getVars.elSlider.querySelector(".active-revslide")), te(e)),
              T.setBSTheme(),
          ...
          init: function (e) {
            return (
              ...
              (e.forEach(function (e) {
                ...
                l.contains("device-xs") ? (t = a) : l.contains("device-sm") ? (t = i) : l.contains("device-md") ? (t = n) : l.contains("device-lg") ? (t = r) : l.contains("device-xl") ? (t = s) : l.contains("device-xxl") && (t = o),
                  ...
                  void t.each(function () {
                    ...
                    "swing" == a && ((a = "swing"), (v = !0)),
                      ...
                      e.find(".flexslider").flexslider({
                        ...
                        after: function (e) {
                          0 < e.parents(".grid-container.has-init-isotope").length && !e.hasClass("flexslider-grid-relayout") && (e.parents(".grid-container.has-init-isotope").isotope("layout"), e.addClass("flexslider-grid-relayout")),
                              ...
                              ? (t
                                ...
                                e
                                  ...
                                  .slideDown("normal", function () {
                                    (jQuery("body").hasClass("device-sm") || jQuery("body").hasClass("device-xs")) && t.hasClass("scroll-on-open") && N.scrollTo(N.offset(e).top - N.getVars.topScrollOffset - 40, 800, "easeOutQuad"),
                        ...
                        s != Number(c) &&
                          ...
                          t.classList.contains("fslider")
                            ? ((i = document.createElement("div")).classList.add("slide"),
                              (i.innerHTML += '<p class="mb-3 ' + n + '">' + r + '</p><small class="d-block"><a href="https://twitter.com/' + a + "/statuses/" + e.id_str + '" target="_blank">' + G(e.created_at) + "</a></small>"),
                              t.querySelector(".slider-wrap").append(i))
                            : (t.innerHTML +=
                                '<li><i class="fa-brands fa-x-twitter"></i><div><span>' + r + '</span><small><a href="https://twitter.com/' + a + "/statuses/" + e.id_str + '" target="_blank">' + G(e.created_at) + "</a></small></div></li>"),
                          s++);
                      }),
              ...
              return (
                ...
                (t = N.getSelector(t, !0, !1)).length < 1 ||
                  void t.each(function () {
                    ...
                    t.jflickrfeed(
                      { feedapi: i, limit: Number(a), qstrings: { id: e }, itemTemplate: '<a class="grid-item" href="{{image_b}}" title="{{title}}" data-lightbox="gallery-item"><img src="{{image_s}}" alt="{{title}}" /></a>' },
                      function (e) {
                    ...
                    .then(function (e) {
                      if (0 < e.length) {
                        ...
                        for (var t, a, i = 0; i < r; i++)
                          i !== r && ((a = (t = e[i]).media_url), "VIDEO" === t.media_type && (a = t.thumbnail_url), (n.innerHTML += '<a class="grid-item" href="' + t.permalink + '" target="_blank"><img src="' + a + '" alt="Image"></a>'));
                      }
              ...
              return (
                ...
                (t = N.getSelector(t)).length < 1 ||
                  (t.each(function () {
                    ...
                    if ((0 < e.filter(".has-init-isotope").length && e.isotope({ masonry: { columnWidth: n } }), a)) for (var r, a = a.split(","), s = "", s = 0; s < a.length; s++) (r = Number(a[s]) - 1), t.eq(r).addClass("grid-item-big");
                    setTimeout(function () {
        ...
        AjaxTrigger: {
          init: function (e) {
            return (
              N.getSelector(e, !1, !1).length < 1 ||
              (N.initFunction({ class: "has-plugin-ajaxtrigger", event: "pluginAjaxTriggerReady" }), (e = N.getSelector(e, !1)).length < 1) ||
              void e.forEach(function (e) {
                var t = {
                  trigger: e,
          ...
          init: function (e) {
            N.isFuncTrue(function () {
              ...
              (i.innerHTML = t.title),
                ...
                (i = !0),
                (i = "hide" == N.cookie.get("__cnvs_tips_cookies") ? !1 : i) &&
                  (e.add("init-plugin-tips"),
                  setTimeout(function () {
                    S.notifications(a);
      ...
      (i = e),
        fastdom.measure(function () {
          var e,
            ...
            a = window.scrollY;
          a >= i.start && a <= i.end
            ? ((e = a - i.start), (t = a - i.offset), (n = (e / i.range.full) * 100), (s = e / i.range.start), (o = a > i.start + i.height && a < i.offset ? ((s = 1), 0) : a >= i.offset ? ((s = 1), t / i.range.end) : 0), (r = s - o))
            : a > i.end
            ? ((n = 100), (r = 0), (s = o = 1))
            : (n = r = s = o = 0),
    ...
    function R(i) {
      fetch(i.loader)
        ...
        .then(function (e) {
          ...
          t &&
            0 < (t = JSON.parse(t)).length &&
            t.forEach(function (e) {
              N.loadCSS(e);
            });
          a &&
            0 < (a = JSON.parse(a)).length &&
            a.forEach(function (e) {
              N.loadJS(e);
            });
          t = new DOMParser().parseFromString(e, "text/html");
          "append" == i.placement ? i.container?.insertAdjacentHTML("beforeend", t.body.innerHTML) : i.container?.insertAdjacentHTML("afterbegin", t.body.innerHTML),
            "true" == i.triggerHide && i.trigger.classList.add("d-none"),
            N.runContainerModules(i.container),
            N.viewport(),
            "true" == i.triggerDisable &&
              setTimeout(function () {
        ...
        fastdom.measure(function () {
          (e.scrollPos.y = window.scrollY),
            e.body.classList.contains("is-expanded-menu") && !e.isMobile
              ...
              : (e.sliderPx.el.querySelector(".slider-inner") ? E(0, 0, e.sliderPx.inner) : E(0, 0, e.sliderPx.el), E(0, 0, e.sliderPx.caption), e.classes.add("slider-parallax-visible"), e.classes.remove("slider-parallax-invisible"));
        });
    }
    function E(e, t, a) {
      a &&
      ...
      if (e) {
        ...
        if (e.classList.contains("dark")) {
          ...
          r && r.classList.add("dark"),
            i || ((r = document.querySelector("#header.transparent-header.sticky-header,#header.transparent-header.semi-transparent.sticky-header,#header.transparent-header.floating-header.sticky-header")) && r.classList.remove("dark")),
    ...
    function B(e) {
      (!N.getVars.elBody.classList.contains("is-expanded-menu") && "true" != N.getVars.mobileSticky) ||
        (window.scrollY > e
          ...
          : (ne(), "true" == N.getVars.mobileSticky && P("responsive")));
    }
    function ne() {
    ...
    function re() {
      ...
      (N.getVars.headerHeight = t.offsetHeight),
        e &&
          ...
          ((t.classList.contains("floating-header") || e.classList.contains("include-topbar")) && (N.getVars.headerHeight = t.offsetHeight + N.offset(t).top), (e.style.marginTop = -1 * N.getVars.headerHeight + "px"), S.sliderParallax());
    }
    function se(e) {
      var t = N.getVars.elBody.classList,
