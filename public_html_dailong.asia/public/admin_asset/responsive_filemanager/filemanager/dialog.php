...
?>
            ...
            <?php if($config['multiple_selection']){ ?><div class="selector">
                ...
                <div class="img-precontainer">
                    ...
                    <!-- Thay đổi thành Url domain ở đây, change url domain here -->
                    <div class="img-container">
                        <img class="<?php echo $show_original ? "original" : "" ?><?php echo $is_icon_thumb ? " icon" : "" ?>" data-src="https://dailong.asia/<?php echo $src_thumb;?>">
                    </div>
                </div>
