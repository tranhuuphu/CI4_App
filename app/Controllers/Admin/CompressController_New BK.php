    ...
    public function single_compress($id){
        ...
        if($image['image_folder'] == 'tinymce'){
            ...
            try {
                ...
                $pathTrash = ROOTPATH.'/public/upload/tinymce/'.'/'.'trash'.'/'.$image['image_TinyCME_name'];
                rename ($path, $pathTrash);
            ...
            unlink('public/upload/tinymce/'.'/'.'trash'.'/'.$image['image_TinyCME_name']);
            ...
            try {
                $source = \Tinify\fromFile($path2);
                $pathTrash = ROOTPATH.'/public/upload/tinymce/'.'/'.$image['image_folder'].'/'.'trash'.'/'.$image['image_TinyCME_name'];
                rename ($path2, $pathTrash);
                $source->toFile($path2);
        ...
        unlink('public/upload/tinymce/'.'/'.$image['image_folder'].'/'.'trash'.'/'.$image['image_TinyCME_name']);
        return redirect()->to('admin/image/imageTiny')->with('success_one', $image['image_TinyCME_name']);
    ...
    public function compress_one($folder, $name){
        ...
        if($image == null){
            ...
            if($folder == "tinymce"){
                ...
                try {
                    $source = \Tinify\fromFile($path);
                    $pathTrash = ROOTPATH.'/public/upload/tinymce/'.'/'.'trash'.'/'.$name;
                    rename ($path, $pathTrash);
                    $source->toFile($path);
                ...
                $imageModel->insert($data);
                unlink('public/upload/tinymce/'.'/'.'trash'.'/'.$name);
            ...
            if($folder != "tinymce"){
                ...
                try {
                    $source = \Tinify\fromFile($path_3);
                    $pathTrash = ROOTPATH.'/public/upload/tinymce/'.'/'.$folder.'/'.'trash'.'/'.$name;
                    rename ($path_3, $pathTrash);
                    $source->toFile($path_3);
                ...
                $imageModel->insert($data3);
                unlink('public/upload/tinymce/'.'/'.$folder.'/'.'trash'.'/'.$name);
                return redirect()->to('admin/image/imageTiny')->with('success_one', $name);
            }
