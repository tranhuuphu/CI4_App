...
class MayMocController extends BaseController
{
    ...
    public function index()
    {
        ...
        $carousel_all = $carousel->where('carousel_status', 1)->find();
        ...
        // dd($data);
        return view('front_end/maymocnganhduc_site/home', $data);
    }
    ...
    public function postCate($slug, $id){
        ...
        if($slug == ""){
            ...
            return view('front_end/maymocnganhduc_site/404_error/404_post_cate');
        }
        ...
        if($cate_detail['cate_type'] == 'blog'){
            ...
            return view('front_end/maymocnganhduc_site/blog_cate', $data);

        }elseif($cate_detail['cate_type'] == 'cate_gallery'){
            $data['pager'] = $gallery->pager;
            return view('front_end/maymocnganhduc_site/gallery_cate', $data);
        }
        else{
            $data['pager'] = $post->pager;
            return view('front_end/maymocnganhduc_site/post_cate', $data);
        }

        
        // return view('front_end/maymocnganhduc_site/post_cate');
    }
    public function table_image(){
        ...
        return view('front_end/maymocnganhduc_site/gallery_cate_table', $data);
    }
    ...
    public function getProd(){
        ...
        return view("front_end/maymocnganhduc_site/prod_cate", $data);
    ...
    public function post($slug2, $title, $id){
        ...
        if($id == null || $id == ""){
            // đặt gallery topic
            return view('front_end/maymocnganhduc_site/404_error/404_post_detail');
        }
        ...
        if($cate_gallery != null && $cate_gallery['cate_type'] == "cate_gallery"){
            ...
            if($gallery_img == null){
                return view('front_end/maymocnganhduc_site/404_error/404_img_detail');
            }
            ...
            return view('front_end/maymocnganhduc_site/gallery_img_detail', $data);
        ...
        if($post_detail['post_status'] == 'san-pham' ){
            ...
            return view('front_end/maymocnganhduc_site/post_prod_detail', $data);
        }else{
            return view('front_end/maymocnganhduc_site/post_detail', $data);
        }
    ...
    public function class_gallery($slug_topic){
        ...
        if($gallery_child == "" && $gallery_parent == ""){
            return view('front_end/maymocnganhduc_site/404_error/404_class_gallery');
        }
        ...
        return view('front_end/maymocnganhduc_site/gallery_img_class', $data);
    }
    ...
    public function cart(){
        if(session('cart') == null){
            $data['items'] = null;
            $data['total'] = null;
            return view('front_end/maymocnganhduc_site/cart', $data);
        }
    ...
    public function order(){    
        if(session('cart') == null){
            return view('front_end/maymocnganhduc_site/404_error/404_cart');
        }
        $data['items'] = array_values(session('cart'));
        $data['total'] = $this->total();
        return view('front_end/maymocnganhduc_site/check-out', $data);
    }
    ...
    public function finishOrder(){
        ...
        if(!$validation){
            ...
            return view('front_end/maymocnganhduc_site/check-out', ['validation'=>$this->validator, 'items'=>$data['items'], 'total'=>$data['total']]);
        }
    ...
    public function tag($tag_slug, $tag_id){
        ...
        if(!isset($tag_detail) || $tag_detail == null){
            ...
            return view('front_end/maymocnganhduc_site/404_error/404_post_cate', $data);
        }
        ...
        return view("front_end/maymocnganhduc_site/getTag", $data);
    ...
    public function getSearch(){
        ...
        if(!isset($key) || $key == null || $key == '+' || $key == '++'){
            return view('front_end/maymocnganhduc_site/404');
        }
        ...
        return view("front_end/maymocnganhduc_site/get_search", $data);
    }
    ...
    public function getPage($page_slug, $id){
        ...
        return view("front_end/maymocnganhduc_site/get_page", $data);
    }
