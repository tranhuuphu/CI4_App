	                  ...
	                  <div class="form-group">
	                    ...
	                    <div class="input-group">
	                      <div class="form-group">
											    ...
											    <input type="file" href="<?= base_url('public/admin_asset/responsive_filemanager') ?>/filemanager/dialog.php?field_id=imgField&lang=en_EN&akey=myPrivateKey" class="form-control-file" id="exampleFormControlFile1">
											  </div>
	                    </div>
	                  </div>
