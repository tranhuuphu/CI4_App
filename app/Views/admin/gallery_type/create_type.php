...
<?= $this->section('content'); ?>
        ...
        <div class="row mb-2">
          <div class="col-sm-12">
            <ol class="breadcrumb float-sm-left">
              ...
              <li class="breadcrumb-item active">Thêm Loại Gallery <small>(Bộ Sưu Tập)</small></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
      	<form action="<?= base_url('admin/type_gallery/store/'); ?>" method="post" enctype="multipart/form-data">
      		<?= csrf_field(); ?>
	        <div class="row">
	          <!-- left column -->
	          ...
	          <div class="col-md-12">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="gallery_type_name" class="form-control" id="exampleInputEmail1" placeholder="Nhập tiêu đề" value="<?= old('gallery_type_name'); ?>">
                  </div>
...
<?= $this->section('script'); ?>
  <script type="text/javascript">
    ...
    $(".type_gallery_active .type_gallery_tree_active2 a:first").addClass("active");
  </script>
...
<?= $this->section('title'); ?>
Thêm Mới Loại Gallery Bộ Sưu Tập
<?= $this->endSection(); ?>