                ...
                <tbody>
                  ...
                  <?php foreach ($image as $value): ?>
                      ...
                      <tr>
                        ...
                        <td>
                          <?= floor($value['image_size_compress']/1024) ?> Kb
                          <p>
                            <i class="fas fa-sort-amount-down"></i> <span class="text-bold text-red"><?php $percent = ($value['image_size_original'] - $value['image_size_compress'])/$value['image_size_original']; echo number_format( $percent * 100, 0 ) .' %'; ?></span>
                          </p>

                        </td>
                        <td>
                            <i class="fas fa-folder"></i> <?= $value['image_folder'] ?>
                        </td>
                      </tr>
