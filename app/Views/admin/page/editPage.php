	            ...
	            <div class="card card-primary">
	              ...
	              <!-- form start -->
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="page_name" class="form-control" id="exampleInputEmail1" placeholder="Nhập tiêu đề bài viết" value="<?php if(old('page_name') != null){echo set_value('page_name');}else{echo $pageDetail['page_name'];} ?>">
                    </div>
                    <hr>
	                  <div class="form-group">
	                    <label for="exampleInputEmail1">Tiêu đề bài viết</label>
                      <p class="text-left text-danger mt-1"><?= isset($validation) ? display_error($validation, 'page_title') : '' ?></p>
	                    <input type="text" name="page_title" class="form-control" id="exampleInputEmail1" placeholder="Nhập tiêu đề bài viết" value="<?php if(old('page_title') != null){echo set_value('page_title');}else{echo $pageDetail['page_title'];} ?>">
	                  </div>
	                  <hr>
	                  ...
	                  <div class="form-group">
                        ...
                        <p class="text-left text-danger mt-1"><?= isset($validation) ? display_error($validation, 'page_content') : '' ?></p>
									      <textarea class="form-control" id="content" name="page_content" rows="3" placeholder="Enter ..." height="800px"><?php if(old('page_content') != null){echo set_value('page_content');}else{echo $pageDetail['page_content'];} ?></textarea>
									    </div>
									  </div>
	                </div>
	                <!-- /.card-body -->
	            ...
	            <div class="card card-success">
                  ...
                  <hr>
                    ...
                    <div class="icheck-primary d-inline pr-3">
                      <input type="radio" id="radioPrimary1" name="page_status" name="r1" value="1" <?php if($pageDetail['page_status'] == 1){echo "checked";} ?>>
                      <label for="radioPrimary1">Có
                      </label>
                    </div>
                    <div class="icheck-primary d-inline">
                      <input type="radio" id="radioPrimary2" <?php if($pageDetail['page_status'] == 1){echo "disabled";} ?> name="page_status" value="0" name="r1" <?php if($pageDetail['page_status'] == 0){echo "checked";} ?>>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <textarea class="form-control" style="height:120px" name="page_meta_desc" maxlength="255"><?php if(old('page_meta_desc') != null){echo set_value('page_meta_desc');}else{echo $pageDetail['page_meta_desc'];} ?></textarea>
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <textarea class="form-control" style="height:120px" name="page_meta_key" maxlength="255"><?php if(old('page_meta_key') != null){echo set_value('page_meta_key');}else{echo $pageDetail['page_meta_key'];} ?></textarea>
                      </div>
                    </div>
                    <hr>
