...
<html dir="ltr" lang="en-US">
  <head>
    ...
    <link rel="stylesheet" href="<?= base_url('public/site_asset/dailong_asset'); ?>/css/custom.css" type="text/css" />


    <link rel="stylesheet" href="<?= base_url('public/site_asset/canvas'); ?>/css/bootstrap.css">
  ...
  <body class="stretched page-transition">
    ...
    <div id="gotoTop" class="uil uil-angle-up rounded border border-primary" data-mobile="true" style="--cnvs-gotoTop-bg:var(--cnvs-contrast-800)"></div>
