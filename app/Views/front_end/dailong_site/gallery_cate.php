          ...
          <div class="grid-inner">
            <div class="portfolio-image">
              ...
              <div class="bg-overlay">
                <div class="bg-overlay-content dark" data-hover-animate="fadeIn">
                  ...
                  <?php if($key2['gallery_link_file_origin'] == null): ?>
            ...
            <div class="portfolio-desc portfolio-desc2">
              ...
              <span>
                ...
                <?php if($key2['gallery_link_file_origin'] != null): ?>
                  <a href="http://ouo.io/qs/iVlhUpN8?s=<?= $key2['gallery_link_file_origin'] ?>" target="_blank"><i class="fas fa-download"></i>&nbsp;<i class="fab fa-google-drive"></i> download file</a>
                <?php endif; ?>
