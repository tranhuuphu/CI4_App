  ...
  <div class="row align-items-center col-mb- mt-5">
    ...
    <div class="col-lg-6">
      <div class="heading-block text-center text-lg-start border-bottom-0">
        <h4>Ooopps.! The <span style="color: red; font-weight: bold;">topic image</span> you were looking for, couldn't be found.</h4>
...
<?= $this->section('yoast_seo'); ?>
  ...
  <title>Error 404 Cannot Find this topic image</title>
